...
public class ExplorerLayout extends LinearLayout implements View.OnClickListener {
	public static final String LOGTAG = "PARACRM/MainMenuActivity";
    ...
    protected void onFinishInflate() {
        ...
        if (!isPaneCollapsible()) {
            mShowHideViews = new View[][][] {
                    ...
                    // STATE_RIGHT_VISIBLE
                    {
                        {mMiddlePane, mRightPane}, // Visible
                        {mLeftPane}, // Invisible
                        {}, // Gone
                    },
            ...
            mShowHideViews = new View[][][] {
                    ...
                    // STATE_MIDDLE_EXPANDED
                    {
                        {mMiddlePane, mRightPane, mFoggedGlass}, // Visible
                        {mLeftPane}, // Invisible
                        {}, // Gone
                    },
            };
    ...
    private void startLayoutAnimation(int duration, AnimatorListener listener,
        ...
        if (mLastAnimatorListener != null) {
            if (ANIMATION_DEBUG) {
                Log.w(LOGTAG, "Anim: Cancelling last animation: " + mLastAnimator);
            }
    ...
    private class AnimatorListener implements Animator.AnimatorListener {
        ...
        private void log(String message) {
            if (ANIMATION_DEBUG) {
                Log.w(LOGTAG, "Anim: " + mLogLabel + "[" + this + "] " + message);
            }
        }
