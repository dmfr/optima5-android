...
public class Utils {
    ...
    public static int getViewTypeFromIntentAndSharedPref(Activity activity) {
        ...
        return CalendarController.ViewType.WEEK ;
    }
    ...
    public static String formatDateRange(
       ...
       // return mTZUtils.formatDateRange(context, startMillis, endMillis, flags);
        ...
        return DateUtils.formatDateRange(context, mF, startMillis, endMillis, flags,
    ...
    */
    ...
    public static String getDayOfWeekString(int julianDay, int todayJulianDay, long millis,
        ...
        */
        StringBuilder mSB = new StringBuilder(50);
        Formatter mF = new Formatter(mSB, Locale.getDefault());
        dayViewText = DateUtils.formatDateRange(context, mF, millis, millis, flags,
        		getTimeZone(context, null)).toString();
