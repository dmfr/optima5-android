...
public class CaptureManager {
    ...
    protected void displayFrameworkBugMessageAndExit() {
        ...
        builder.setTitle("zxing_app_name");
        builder.setMessage("zxing_msg_camera_framework_bug");
        builder.setPositiveButton("zxing_button_ok", new DialogInterface.OnClickListener() {
            @Override
