...
public class CalendarViewAdapter extends BaseAdapter {
    ...
    public CalendarViewAdapter(Context context, int viewType) {
        ...
        // Initialize
        String buttons[] = {"Day","Week","Month","Agenda"} ;
        mButtonNames = buttons;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null ||
                ((Integer)convertView.getTag()).intValue() !=
                    R.layout.calendar_actionbar_pulldown_menu_top_button) {
            v = mInflater.inflate(R.layout.calendar_actionbar_pulldown_menu_top_button, parent, false);
            // Set the tag to make sure you can recycle it when you get it as a convert view
            v.setTag(new Integer(R.layout.calendar_actionbar_pulldown_menu_top_button));
        } else {
            v = convertView;
        }
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        View v = mInflater.inflate(R.layout.calendar_actionbar_pulldown_menu_button, parent, false);
    ...
    private String buildDayOfWeek() {
        ...
        if (julianDay == mTodayJulianDay) {
            dayOfWeek = String.format("TODAY %s",
            ...
            dayOfWeek = String.format("YESTERDAY %s",
                    DateUtils.formatDateRange(mContext, mFormatter, mMilliTime, mMilliTime,
                            DateUtils.FORMAT_SHOW_WEEKDAY, mTimeZone).toString());
        } else if (julianDay == mTodayJulianDay + 1) {
            dayOfWeek = String.format("TOMORROW %s",
                    DateUtils.formatDateRange(mContext, mFormatter, mMilliTime, mMilliTime,
                            DateUtils.FORMAT_SHOW_WEEKDAY, mTimeZone).toString());
        } else {
